# scenario 1_1: color is decisive criterion (green object in scene => 0; blue object in scene = 1)
# Restrictions:
...
def compute_scenario1_1(counter, scene_width, scene_height, obj1, obj2, path):
    cntr = 1
    image_names = []
    position_x = []
    position_y = []
    ...
    while cntr < counter:
        ...
        cntr = cntr+1
    save_values_as_xlsx(path, "scenario_1_1.xlsx", image_names, position_x, position_y, size_x, size_y, shapes, colors, label)