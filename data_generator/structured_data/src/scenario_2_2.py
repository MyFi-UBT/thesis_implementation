...
def compute_scenario2_2(counter, scene_width, scene_height, obj3, obj3_1, obj4, obj4_1, path):
    image_names = []
    positions_x_obj1 = []
    positions_y_obj1 = []
    sizes_x_obj1 = []
    ...
    while label_counter_good < counter / 2 or label_counter_bad < counter / 2:
        ...
        if label_counter_good < counter / 2:
            if obj3.position[1] > scene_height - (scene_height / 7) or obj3_1.position[1] > scene_height - (
                ...
                # paint_image(1, reason, random_nr, random_nr_2, scene_height, scene_width, obj_array, "../validation_images/scenario2_2/")
        else:
            if label_counter_bad < counter / 2:
                ...
                # use the next method to paint an image in order to validate the generated data
                # paint_image(0, "undefined", random_nr, random_nr_2, scene_height, scene_width, obj_array, "../validation_images/scenario2_2/")

    save_values_as_xlsx_4objects(path, "scenario_2_2.xlsx", image_names, positions, sizes, shapes, colors, label)
